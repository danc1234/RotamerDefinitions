...
### Missing Amino Acids 
Amino acids are missing in the dihedral .csv files because those amino acids do not have long enough carbon chains to define chi-angles for those amino acids, especially for chi-angles 3, 4, and 5.
